...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(UserDetailsService userDetailsService, BCryptPasswordEncoder bCryptPasswordEncoder, HelperService helperService) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        CustomAuthenticationFilter customAuthenticationFilter =
                new CustomAuthenticationFilter(authenticationManagerBean(), helperService);
        customAuthenticationFilter.setFilterProcessesUrl("/api/newlogin");
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS);
        http.authorizeRequests().antMatchers("/api/newlogin/**", "/api/token/refresh/**").permitAll();
        ...
        http.addFilterBefore(new CustomAuthorizationFilter(helperService), UsernamePasswordAuthenticationFilter.class);
    }
